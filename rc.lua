...
beautiful.init("/home/michael/.config/awesome/themes/default/theme.lua")
...
batwidget0:set_color({ type = "linear", from = { 0, 0 }, to = { 10,0 }, stops = { {0, "#AECF96"}, {0.5, "#88A175"}, 
                     {1, "#FF5656"}}})
...
batwidget1:set_color({ type = "linear", from = { 0, 0 }, to = { 10,0 }, stops = { {0, "#AECF96"}, {0.5, "#88A175"}, 
                     {1, "#FF5656"}}})
...
awful.rules.rules = {
    ...
    { rule = { class = "gimp" },
      properties = { floating = true } },
    -- Set Firefox to always map on tags number 2 of screen 1 and switch to that tag imidiatelly.
    { rule = { class = "Firefox" },
